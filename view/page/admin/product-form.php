    ...
    <div class="row">
        <form class="col l8 s12 offset-l2" action="<?=$submitUrl?>" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <label>
                    <div class="col s6 l4">
                        <div class="square square-upload-image valign-wrapper materialize-tooltip" data-position="right" data-tooltip="Enviar Imagens do Produto">
            ...
            <div class="row">
                <div class="col l4 s6">
                    <button type="submit" class="blue waves-effect waves-light btn btn-block">Salvar</button>
                </div>
                <div class="col l4 s6">
                    <a href="<?=baseurl('admin/product')?>" class="grey waves-effect waves-light btn btn-block">Voltar</a>
                </div>
            </div>
        </form>
    </div>
